...
Light <- function(kw,kp,DeltaZ,P,I0){
  ...
  #calculation of the light values 
  I = I0*exp(-integral)
...
#Maximum 
plot(N_out[ dim(N_out)[2],], -z_values, type = "l", col = "peru", lwd=4, xlim = c(0,5), xlab = "mmol N/m^3", ylab = "Depth [m]", main = "NPD model - Steady state (maximum)", cex.lab=1.25)
lines(P_out[ dim(P_out)[2],], -z_values, type = "l", col = "darkgreen", lwd=4)
...
plot(N_last, -z_values, type = "l", col = "peru", lwd = 4, xlim = c(0, 5), xlab = "mmol N/m^3", ylab = "Depth [m]", main = "NPD model - Steady state (last timestep)", cex.lab = 1.25)
legend(
  "topright",
  legend = c("Nutrients"),
  lty = c(1, 1,1),
...
plot(P_last, -z_values, type = "l", col = "darkgreen", lwd = 4, xlab = "mmol N/m^3", ylab = "Depth [m]", main = "Phytoplankton and Detritus (last timestep)", cex.lab = 1.25)
lines(D_last, -z_values, type = "l", col = "brown4", lwd = 4)
legend(
  "topright",
  legend = c("Phytoplankton", "Detritus"),
  lty = c(1, 1,1),
  lwd = 3,
...
#Last timestep
plot(N_last, -z_values, type = "l", col = "peru", lwd = 4, xlim = c(0, 5), xlab = "mmol N/m^3", ylab = "Depth [m]", main = "NPD model - Steady state (last timestep)", cex.lab = 1.25)
lines(P_last, -z_values, type = "l", col = "darkgreen", lwd = 4)
lines(D_last, -z_values, type = "l", col = "brown4", lwd = 4)
legend(
  "topright",
  #inset = c(-0.5, 0),
